...
import com.myandayush.quizeapp.databinding.ActivityMathematicQuizBinding

class MathematicQuiz : AppCompatActivity() {

    private lateinit var binding: ActivityMathematicQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMathematicQuizBinding.inflate(layoutInflater)

        setContentView(binding.root)

        list = ArrayList<QuestionModel>()
        val db = FirebaseFirestore.getInstance()
        db.collection("MathematicsQz")
