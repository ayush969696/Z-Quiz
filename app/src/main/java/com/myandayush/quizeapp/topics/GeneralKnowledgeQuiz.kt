...
import com.myandayush.quizeapp.databinding.ActivityGeneralKnowledgeQuizBinding

class GeneralKnowledgeQuiz : AppCompatActivity() {
    private lateinit var binding: ActivityGeneralKnowledgeQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGeneralKnowledgeQuizBinding.inflate(layoutInflater)
        setContentView(binding.root)

        list = ArrayList<QuestionModel>()
        val db = FirebaseFirestore.getInstance()

        db.collection("GeneralknowledgeQuz")
